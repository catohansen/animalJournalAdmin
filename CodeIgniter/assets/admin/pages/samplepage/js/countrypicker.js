    ...
    for (i = 0; i < countryInput.length; i++) {
        ...
        if (flag) {
            ...
            $.each(countries, function (index, country) {
                var flagIcon = base_url+"/animaljournalAdmin/CodeIgniter/assets/admin/pages/samplepage/css/flags/" + country.code + ".png";
            ...
            countryInput.eq(i).on('loaded.bs.select', function (e) {
                ...
                var flagIcon = base_url+"/animaljournalAdmin/CodeIgniter/assets/admin/pages/samplepage/css/flags/" + def + ".png";
            ...
            countryInput.eq(i).on('change', function () {
                ...
                flagIcon =  base_url+"/animaljournalAdmin/CodeIgniter/assets/admin/pages/samplepage/css/flags/" + def + ".png";
                button.css("background-size", '20px');
                button.css("background-position", '10px 9px');
                button.css("padding-left", '40px');
                button.css("background-repeat", 'no-repeat');
